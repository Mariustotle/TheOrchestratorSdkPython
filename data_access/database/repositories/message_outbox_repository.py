...
class MessageOutboxRepository(RepositoryBase):
    ...
    def get_message_by_id(self, source_map_message_id) -> MessageOutboxSchema:
        
        db_entity = self.session.query(MessageOutboxEntity).filter_by(source_map_message_id=source_map_message_id).first()
