...
class HeaderProperties:
    ...
    def __init__(self, account_id, application_name, message_id, map_message_id, group_trace_key, dispatcher, message_name, message_type, process_structure, reference, activity_type, priority = None): 
