...
class CallbackContext:
    ...
    action_type: ContextVar[str] = ContextVar("action_type")  

    def __init__(self, account_id, message_id, group_trace_key, dispatcher, message_name, message_type, reference, action_type):
        ...
        self._action_type_token = self.reference.set(action_type)
    ...
    def __exit__(self, exc_type, exc_val, exc_tb):
        ...
        self.action_type.reset(self._action_type_token)
