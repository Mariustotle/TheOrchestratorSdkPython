...
class EventHeaders():
    ...
    @staticmethod
    def Create(message_id_string:str, message_trace_id_string:str, message_name:str, application_name:str, dispatcher:str, activity_type_string:str, message_type_string:str, reference:str, priority_string:str):        
