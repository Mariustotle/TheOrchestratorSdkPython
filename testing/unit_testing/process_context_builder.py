...
class ProcessContextBuilder() : 
    ...
    def __init__(self, message_name:str, source_message_trace_id:Optional[str] = None, source_map_message_id:Optional[UUID] = None, 
                 source_priority:Optional[int] = None, reference:Optional[str] = None):
        
        self.message_name = message_name
        self.source_message_trace_id = source_message_trace_id
        self.source_map_message_id = source_map_message_id if source_map_message_id != None else uuid.uuid4()
